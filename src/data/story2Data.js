...
export const story2Tips = [
  'Вклад — твои деньги работают на тебя и приносят доход!',
  'Кредит удобен, когда деньги нужны срочно, но требует переплаты!',
  '15% годовых означает, что каждый год ты получаешь или отдаёшь 15% от суммы!',
  'Залог — это вещь, которую ты можешь потерять, если не вернёшь долг!',
  'Копить сложнее, но выгоднее в конце!',
  'Маленькие сбережения превращаются в большую цель!',
  'Планируй бюджет заранее, чтобы не брать кредиты!',
