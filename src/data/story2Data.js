...
export const story1Dialogs = [
  ...
  { speaker: 'mother', text: (balance) => `Прямо как взрослый. Держи ${balance} рублей. Это все наши деньги на покупки. И вот список.` },
  ...
  { speaker: 'child', text: (balance) => `Итак... У меня ${balance} рублей. Что же я могу купить?` }
]
