export const familyDialogs = [
  { speaker: 'girl', text: 'Мам, пап, мне на день рождения подарили 10 000 рублей! Я коплю на планшет, но не хватает ещё 2 000. Что делать?' },
...
export const story2IntroText = {
  ...
  text: 'Лисичка мечтает о новом планшете, но ей не хватает 2 000 ₽. Мама предлагает открыть вклад, а папа — взять кредит. Что выберешь ты?'
}
