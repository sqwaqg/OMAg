  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <img src={foxGirl} alt="Лисичка" style={{ width: '100%', height: 'auto' }} />
        {/* Планшет появляется */}
        {showTablet && (
          <div style={{
            position: 'absolute',
            ...
            right: '-20%',
            width: '80px',
            animation: 'tabletAppear 0.5s ease'
          }}>
      ...
      <div style={{
        ...
        <h2 style={{ color: '#2e7d32', marginBottom: '15px', fontSize: '1.8rem' }}>
          Поздравляем!
        </h2>
      ...
      <style>{`
        ...
        @keyframes tabletAppear { from { opacity: 0; transform: scale(0) rotate(-20deg); } to { opacity: 1; transform: scale(1) rotate(0); } }
      `}</style>
    </div>
  );
}
